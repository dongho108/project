...
name_Model = "Attention_Model_"+str(numData)
name_encoder_model = "Attention_encoder_Model_"+str(numData)
name_decoder_model = "Attention_decoder_Model_"+str(numData)
...
# ㅡㅡㅡㅡㅡㅡㅡㅡㅡ 직접 작성한 부분 ㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡ
# encoder_model.save(name_encoder_model) 인코더 모델 저장
# ㅡㅡㅡㅡㅡㅡㅡㅡㅡ 직접 작성한 부분 ㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡ
